...
/* ============================================================
   FOOTER (Fixed, Normal Height)
   ============================================================ */
function Footer({ copyEmail }) {
  return (
    <footer style={{ background: "#E7E7E7", borderTop: "1px solid #D1D1D1", padding: "2rem 1.5rem", textAlign: "center", width: "100%", zIndex: 150, position: "relative" }}>
